...
int main(int argc, char *argv[])
{
  argagg::parser arguments{{{"help", {"-h", "--help"}, "display help information", 0},
      ...
      {"write-back-buffer" , {"--wbb"}, "write back buffer for clank optimization (Y/N)", 1}}};
